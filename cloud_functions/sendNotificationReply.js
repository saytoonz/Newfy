...
exports.sendNotificationReply = functions.firestore.document("Users/{user_id}/Notifications_reply/{notification_id}").onWrite((change,context)=> {
    ...
    return db.collection("Users").doc(user_id).collection("Notifications_reply").doc(notification_id).get().then(queryResult=>{
        ...
        return Promise.all([from_data, to_data]).then(result=>{
            ...
            const payload={
               data:{
                ...
                click_action:"com.nsromapa.frenzapp.TARGETNOTIFICATIONREPLY"
              }
